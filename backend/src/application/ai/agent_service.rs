...
mod tests {
    ...
    fn agent_tool_input_adapters_live_in_novex_tools() {
        ...
        assert!(source.contains("feishu_message_text_from_tool_input,"));
        assert!(source.contains("github_read_request_from_tool_input,"));
        assert!(source.contains("github_search_request_from_tool_input,"));
        assert!(source.contains("media_image_request_from_tool_input,"));
