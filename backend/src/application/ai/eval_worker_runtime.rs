...
use novex_eval::{
    score_case, score_cost_case, score_latency_case, score_retrieval_recall_case, EvalCaseActual,
    EvalCaseExpected, EvalCaseScore, EvalMetricKind, EvalTargetKind,
};
...
use crate::{
    ...
    infrastructure::{
        ...
        persistence::ai_eval_repository::{
