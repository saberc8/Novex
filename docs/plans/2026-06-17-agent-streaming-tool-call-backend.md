...
Run: `cargo test -p backend-rust provider_stream_tool_call --offline`
...
Run: `cargo test -p backend-rust model_stream_tool_call --offline && cargo test -p novex-eval streaming_tool_call --offline`
...
cargo test -p backend-rust model_stream_tool_call --offline
